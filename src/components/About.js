        ...
        <article className="about__content col-md-8 col-lg-7 d-flex flex-column align-items-start">
          ...
          <div className="accordion__paper ms-md-5" id="accordionExample">
            ...
            <div className="mt-5">
              ...
              >
                <p>
                  Arrancamos con el objetivo de traer a nuestro pueblo, prendas
                  que no se conseguían accesiblemente, y de estilos que no eran
                  muy populares en la zona. Gracias a esto, conocimos varios
                  lugares del país y nos familiarizamos con el mundo de la{" "}
